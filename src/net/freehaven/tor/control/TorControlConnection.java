...
public class TorControlConnection implements TorControlCommands {
    ...
    /**
     * Sets <b>w</b> as the PrintWriter for debugging output, which writes out
     * all messages passed between Tor and the controller. Outgoing messages are
     * preceded by "\>\>" and incoming messages are preceded by "\<\<"
     */
    ...
    /**
     * Sets <b>s</b> as the PrintStream for debugging output, which writes out
     * all messages passed between Tor and the controller. Outgoing messages are
     * preceded by "\>\>" and incoming messages are preceded by "\<\<"
     */
     ...
     * immediately. If it's an OR, close listeners and exit after 30
     * seconds</li>
     * <li>"DUMP" or "USR1" : Dump stats: log information about open connections
     * and circuits</li>
     * <li>"DEBUG" or "USR2" : Debug: switch all open logs to loglevel
     * debug</li>
